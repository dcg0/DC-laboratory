import{S as e}from"./index-DmjaE0dS.js";import{s as te,m as oe,d as ae,a as re,l as ne}from"./logDepthDeclaration-B_Dso5t0.js";import{h as le}from"./helperFunctions-CceASNKY.js";import{c as se,f as fe,a as de,b as ce}from"./fogFragment-CTAgtJAO.js";const t="decalFragmentDeclaration",R=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=R);const ve={name:t,shader:R},o="defaultFragmentDeclaration",X=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=X);const he={name:o,shader:X},a="objectIdFunctions",F=`highp vec4 encodeObjectId(highp float objectId) {
...
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=F);const ue={name:a,shader:F},r="prePassDeclaration",_=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=_);const pe={name:r,shader:_},n="oitDeclaration",N=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=N);const me={name:n,shader:N},l="lightFragmentDeclaration",M=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=M);const ge={name:l,shader:M},s="lightUboDeclaration",O=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=y);const Ee={name:f,shader:y},d="clusteredLightingFunctions",b=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=b);const Te={name:d,shader:b},c="lightsFragmentFunctions",U=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=U);const De={name:c,shader:U},v="shadowsFragmentFunctions",H=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=H);const Ce={name:v,shader:H},h="samplerFragmentDeclaration",W=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=W);const Ie={name:h,shader:W},u="fresnelFunction",G=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=G);const Le={name:u,shader:G},p="reflectionFunction",z=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=z);const Ae={name:p,shader:z},m="imageProcessingDeclaration",V=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=V);const we={name:m,shader:V},g="imageProcessingFunctions",B=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=B);const xe={name:g,shader:B},S="textureRepetitionFunctions",k=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=k);const Pe={name:S,shader:k},E="bumpFragmentMainFunctions",Y=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=Y);const Re={name:E,shader:Y},T="bumpFragmentFunctions",$=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=$);const Xe={name:T,shader:$},D="bumpFragment",Z=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Z);const Fe={name:D,shader:Z},C="decalFragment",j=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=j);const _e={name:C,shader:j},I="defaultFragmentAlpha",q=`#ifdef OPACITY
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=q);const Ne={name:I,shader:q},L="depthPrePass",Q=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Q);const Me={name:L,shader:Q},A="lightFragment",J=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=J);const Oe={name:A,shader:J},w="logDepthFragment",K=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=K);const ye={name:w,shader:K},x="oitFragment",ee=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=ee);const be={name:x,shader:ee},P="defaultPixelShader",ie=`#define CUSTOM_FRAGMENT_EXTENSION
...
#endif
#ifdef PREPASS_COLOR
WRITE_GEOMETRY_FRAGMENT_OUTPUT(PREPASS_COLOR_INDEX,color); 
#endif
...
vec2 a=(vCurrentPosition.xy/vCurrentPosition.w)*0.5+0.5;vec2 b=(vPreviousPosition.xy/vPreviousPosition.w)*0.5+0.5;vec2 velocity=abs(a-b);velocity=vec2(pow(velocity.x,1.0/3.0),pow(velocity.y,1.0/3.0))*sign(a-b)*0.5+0.5;WRITE_GEOMETRY_FRAGMENT_OUTPUT(PREPASS_VELOCITY_INDEX,vec4(velocity,0.0,writeGeometryInfo));
#elif defined(PREPASS_VELOCITY_LINEAR)
vec2 velocity=vec2(0.5)*((vPreviousPosition.xy/vPreviousPosition.w)-(vCurrentPosition.xy/vCurrentPosition.w));WRITE_GEOMETRY_FRAGMENT_OUTPUT(PREPASS_VELOCITY_LINEAR_INDEX,vec4(velocity,0.0,writeGeometryInfo));
#endif
#ifdef PREPASS_IRRADIANCE
WRITE_GEOMETRY_FRAGMENT_OUTPUT(PREPASS_IRRADIANCE_INDEX,vec4(0.0,0.0,0.0,writeGeometryInfo)); 
#endif
#ifdef PREPASS_DEPTH
WRITE_GEOMETRY_FRAGMENT_OUTPUT(PREPASS_DEPTH_INDEX,vec4(vViewPos.z,0.0,0.0,writeGeometryInfo)); 
#endif
...
#if defined(SPECULAR)
WRITE_GEOMETRY_FRAGMENT_OUTPUT(PREPASS_REFLECTIVITY_INDEX,vec4(toLinearSpace(specularMapColor))*writeGeometryInfo); 
#else
...
`;e.ShadersStore[P]||(e.ShadersStore[P]=ie);const Ue=[ve,he,te,oe,ae,ue,pe,me,re,le,ge,Se,Ee,Te,De,Ce,Ie,Le,Ae,we,xe,Pe,Re,Xe,se,ne,fe,de,Fe,_e,Ne,Me,Oe,ye,ce,be];for(const i of Ue)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const Ve={name:P,shader:ie};export{Ve as defaultPixelShader};
