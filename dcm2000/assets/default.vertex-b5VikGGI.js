import{S as e}from"./index-DmjaE0dS.js";import{s as B,m as w,d as Y,a as $,l as z}from"./logDepthDeclaration-B_Dso5t0.js";import{h as j}from"./helperFunctions-CceASNKY.js";import{b as k,a as Q,i as Z,c as K,f as q,d as J,e as ee,g as ie,h as ne,j as te,v as re}from"./vertexColorMixing-CmKz4OVe.js";const n="decalVertexDeclaration",h=`#ifdef DECAL
...
`;e.ShadersStore[N]||(e.ShadersStore[N]=b);const pe=[ae,de,B,w,Y,oe,j,k,Q,Z,fe,$,se,le,K,q,ce,Ee,Ie,me,z,ve,ue,J,ee,ie,Ae,Te,_e,Se,ne,te,Ne,re,he,Me];for(const i of pe)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const De={name:N,shader:b};export{De as defaultVertexShader};
