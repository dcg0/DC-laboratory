import{S as e}from"./index-DmjaE0dS.js";const t="bonesDeclaration",l=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=l);const V={name:t,shader:l},n="bakedVertexAnimationDeclaration",c=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=c);const C={name:n,shader:c},r="clipPlaneVertexDeclaration",I=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=I);const _={name:r,shader:I},i="fogVertexDeclaration",x=`#ifdef FOG
varying vFogDistance: vec3f;
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=x);const O={name:i,shader:x},a="instancesDeclaration",E=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=E);const W={name:a,shader:E},f="instancesVertex",S=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=S);const R={name:f,shader:S},s="bonesVertex",N=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=N);const h={name:s,shader:N},d="bakedVertexAnimation",v=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=v);const F={name:d,shader:v},o="clipPlaneVertex",p=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=p);const P={name:o,shader:p},m="fogVertex",A=`#ifdef FOG
#ifdef SCENE_UBO
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=A);const U={name:m,shader:A},u="vertexColorMixing",L=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=L);const b={name:u,shader:L};export{C as a,V as b,_ as c,R as d,h as e,O as f,F as g,P as h,W as i,U as j,b as v};
