import{S as e}from"./index-DmjaE0dS.js";import{s as ee,m as re,d as te,a as ae,l as ie}from"./logDepthDeclaration-DHBSPoZV.js";import{h as oe}from"./helperFunctions-DUY6Lkv0.js";import{c as fe,f as ne,a as se,b as le}from"./fogFragment-DIrFbFGy.js";const t="objectIdFunctions",P=`fn encodeObjectId(objectId: f32)->vec4f {
...
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=P);const de={name:t,shader:P},a="prePassDeclaration",X=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=X);const ce={name:a,shader:X},i="oitDeclaration",_=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=_);const ve={name:i,shader:_},o="lightUboDeclaration",R=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=R);const ue={name:o,shader:R},f="ltcHelperFunctions",y=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=y);const pe={name:f,shader:y},n="clusteredLightingFunctions",F=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=F);const he={name:n,shader:F},s="clusteredLightingCompute",N=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=N);const me={name:s,shader:N},l="lightsFragmentFunctions",M=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=M);const Se={name:l,shader:M},d="shadowsFragmentFunctions",O=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=O);const ge={name:d,shader:O},c="samplerFragmentDeclaration",b=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=b);const xe={name:c,shader:b},v="fresnelFunction",W=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=W);const Te={name:v,shader:W},u="reflectionFunction",G=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=G);const Le={name:u,shader:G},p="imageProcessingDeclaration",z=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=z);const we={name:p,shader:z},h="imageProcessingFunctions",U=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=U);const Ce={name:h,shader:U},m="textureRepetitionFunctions",H=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=H);const Ee={name:m,shader:H},S="bumpFragmentMainFunctions",V=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=V);const Ie={name:S,shader:V},g="bumpFragmentFunctions",B=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=B);const De={name:g,shader:B},x="bumpFragment",k=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=k);const Ae={name:x,shader:k},T="decalFragment",Y=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=Y);const Pe={name:T,shader:Y},L="defaultFragmentAlpha",$=`#ifdef OPACITY
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=$);const Xe={name:L,shader:$},w="depthPrePass",j=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=j);const _e={name:w,shader:j},C="lightFragment",q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=q);const Re={name:C,shader:q},E="logDepthFragment",Z=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=Z);const ye={name:E,shader:Z},I="meshBlendTagFragmentOutput",Q=`#if SCENE_MRT_COUNT>{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=Q);const Fe={name:I,shader:Q},D="oitFragment",J=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=J);const Ne={name:D,shader:J},A="defaultPixelShader",K=`#include<defaultUboDeclaration>
...
#ifdef PREPASS_MESH_BLEND_TAG
var meshBlendTagOutput: vec4<u32>=vec4u(0u);if (writeGeometryInfo>0.0) {meshBlendTagOutput=vec4u(u32(uniforms.meshBlendTag),0u,0u,0u);}
#endif
#ifdef PREPASS_COLOR
...
`;e.ShadersStoreWGSL[A]||(e.ShadersStoreWGSL[A]=K);const Me=[ee,re,te,de,ce,ve,ae,oe,ue,pe,he,me,Se,ge,xe,Te,Le,we,Ce,Ee,Ie,De,fe,ie,ne,se,Ae,Pe,Xe,_e,Re,ye,le,Fe,Ne];for(const r of Me)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const ze={name:A,shader:K};export{ze as defaultPixelShaderWGSL};
