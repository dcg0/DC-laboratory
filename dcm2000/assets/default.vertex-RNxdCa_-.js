import{S as e}from"./index-DmjaE0dS.js";import{s as z,m as C,d as H,a as w,l as B}from"./logDepthDeclaration-DHBSPoZV.js";import{h as Y}from"./helperFunctions-DUY6Lkv0.js";import{b as $,a as j,i as k,c as Q,f as K,d as Z,e as q,g as J,h as ee,j as te,v as ie}from"./vertexColorMixing-gDWqPTQ1.js";const i="uvAttributeDeclaration",S=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
...
`;e.ShadersStoreWGSL[T]||(e.ShadersStoreWGSL[T]=F);const Se=[z,C,H,re,Y,$,j,k,ne,w,ae,fe,Q,K,de,oe,se,ue,B,ve,le,pe,ce,Z,q,J,_e,me,xe,Ee,ee,te,Ie,ie,Te];for(const t of Se)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const Oe={name:T,shader:F};export{Oe as defaultVertexShaderWGSL};
